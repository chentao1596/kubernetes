...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_KubeletInstanceConfiguration_To_kubeletconfig_KubeletInstanceConfiguration,
		Convert_kubeletconfig_KubeletInstanceConfiguration_To_v1beta1_KubeletInstanceConfiguration,
...
func autoConvert_v1beta1_KubeletInstanceConfiguration_To_kubeletconfig_KubeletInstanceConfiguration(in *KubeletInstanceConfiguration, out *kubeletconfig.KubeletInstanceConfiguration, s conversion.Scope) error {
	out.RunOnce = in.RunOnce
	return nil
}

// Convert_v1beta1_KubeletInstanceConfiguration_To_kubeletconfig_KubeletInstanceConfiguration is an autogenerated conversion function.
func Convert_v1beta1_KubeletInstanceConfiguration_To_kubeletconfig_KubeletInstanceConfiguration(in *KubeletInstanceConfiguration, out *kubeletconfig.KubeletInstanceConfiguration, s conversion.Scope) error {
	return autoConvert_v1beta1_KubeletInstanceConfiguration_To_kubeletconfig_KubeletInstanceConfiguration(in, out, s)
}

func autoConvert_kubeletconfig_KubeletInstanceConfiguration_To_v1beta1_KubeletInstanceConfiguration(in *kubeletconfig.KubeletInstanceConfiguration, out *KubeletInstanceConfiguration, s conversion.Scope) error {
	out.RunOnce = in.RunOnce
	return nil
}

// Convert_kubeletconfig_KubeletInstanceConfiguration_To_v1beta1_KubeletInstanceConfiguration is an autogenerated conversion function.
func Convert_kubeletconfig_KubeletInstanceConfiguration_To_v1beta1_KubeletInstanceConfiguration(in *kubeletconfig.KubeletInstanceConfiguration, out *KubeletInstanceConfiguration, s conversion.Scope) error {
	return autoConvert_kubeletconfig_KubeletInstanceConfiguration_To_v1beta1_KubeletInstanceConfiguration(in, out, s)
}
